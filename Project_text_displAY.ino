...
// Matrix setup params
Adafruit_NeoMatrix matrix = Adafruit_NeoMatrix(36, 8, DATA_PIN,
NEO_MATRIX_TOP    + NEO_MATRIX_RIGHT +
NEO_MATRIX_COLUMNS + NEO_MATRIX_ZIGZAG+ NEO_MATRIX_PROGRESSIVE ,
NEO_GRB            + NEO_KHZ800);
...
//char* Text[]= {"Hello Friends","Welcome To","Electronic's Kraft","PLZ","LIKE,","SHARE,","& Subscribe"};
char* Text[]= {"Hello Friends Welcome To","Electronic's Kraft","PLZ LIKE SHARE & Subscribe"};
const uint16_t colors[] = {
  //matrix.Color(255, 0, 255), matrix.Color(100, 255, 0), matrix.Color(255, 125, 0), matrix.Color(255, 0, 125), matrix.Color(100, 255, 255), matrix.Color(255, 255, 255)};
  matrix.Color(255, 215, 0), matrix.Color(199, 15, 85), matrix.Color(255, 125, 0), matrix.Color(220, 14, 60), matrix.Color(0, 255, 255), matrix.Color(255, 255, 255)};
int brightness = 60;
// End Edit
